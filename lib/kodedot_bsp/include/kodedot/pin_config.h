...
/* ---------- Built-in Speaker ---------- */
// I2S speaker pins
#define SPEAKER_SCK            38      // GPIO38 - I2S SCK
#define SPEAKER_WS             45      // GPIO45 - I2S WS
#define SPEAKER_DOUT           46      // GPIO46 - I2S DOUT
// Speaker amplifier control via IO expander
#define SPEAKER_AMP_EN         EXPANDER_SPK_SHUTDOWN  // P03 - Speaker shutdown/amplifier enable
// Note: The amplifier is off by default to save energy. Set SPEAKER_AMP_EN to HIGH to turn it on.
